...
export default class Post extends Component {
  constructor() {
    ...
    // hideEdit responsible for toggling the edit component off after pressing the update button
  ...
  render() {
    ...
    // destructoring text and date from props
        ...
        <div className="Post__content">
          {
            ...
            editing ? (
              <Edit
                ...
                updatePostFn={updatePostFn} // same as id
              />
            ) : (
